...
import styles from './NavComponentSection.module.scss'
import { Link } from 'react-router-dom'
function NavComponentSection({primaryLink, secondLink}) {
  return (
    <nav className={styles.nav}>
      <Link to='/' className={styles.nav_link}>{primaryLink}</Link>
      ...
      <p className={styles.nav_descr}>{secondLink}</p>
    </nav>
  )
}

export default NavComponentSection